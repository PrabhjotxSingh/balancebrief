...
examples=[
  ...
  Example("I filed my claim 2 weeks ago but I still havent received a deposit for it.", "Filing a claim and viewing status"),
  ...
  "Cancelling coverage"),
  Example("Your service sucks. Im switching providers. Cancel my coverage.", "Cancelling coverage"),
